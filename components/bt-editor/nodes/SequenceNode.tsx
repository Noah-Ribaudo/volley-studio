...
function SequenceNode({ data }: NodeProps<BTFlowNodeData>) {
  ...
  const nodeContent = (
    <div
      className="relative px-3 py-2 rounded-lg border-2 bg-slate-700/80 backdrop-blur-sm transition-all duration-300"
      style={{
