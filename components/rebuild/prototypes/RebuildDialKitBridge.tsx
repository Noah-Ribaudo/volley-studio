  ...
  const params = useDialKit(
    panelName,
    {
      ...
      joystick: {
        ...
        baseScale: [seed.joystick.baseScale, 0.72, 1.2, 0.01],
        baseLightness: [seed.joystick.baseLightness, 0.25, 0.85, 0.01],
        ...
        showDialShellRing: seed.joystick.showDialShellRing,
  ...
  const nextTuning = useMemo(() => {
    ...
    return sanitizeTactileTuning({
      ...
      joystick: {
        ...
        showDialShellRing: params.joystick.showDialShellRing,
