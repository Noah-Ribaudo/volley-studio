...
export interface PhasePadHardwareTuning {
  ...
  channelWidth: number
  piecesPerLongSide: number
  piecesPerShortSide: number
  pieceLengthLongSide: number
  pieceLengthShortSide: number
...
export const DEFAULT_TACTILE_TUNING: TactileTuning = {
  ...
  phasePadHardware: {
    trackWidth: 91,
    trackHeight: 85.3,
    trackCornerRadius: 1.5,
    channelWidth: 12.25,
    piecesPerLongSide: 10,
    piecesPerShortSide: 6,
    pieceLengthLongSide: 18.5,
    pieceLengthShortSide: 18.4,
    pieceThickness: 10.4,
    pieceRadius: 4.45,
...
export function sanitizeTactileTuning(input: TactileTuning): TactileTuning {
  return {
    ...
    joystick: {
      ...
      haloIntensity: clamp(input.joystick.haloIntensity, 0, 2),
    ...
    phasePadHardware: {
      ...
      piecesPerLongSide: clamp(Math.round(input.phasePadHardware.piecesPerLongSide), 2, 32),
      piecesPerShortSide: clamp(Math.round(input.phasePadHardware.piecesPerShortSide), 2, 32),
      pieceLengthLongSide: clamp(input.phasePadHardware.pieceLengthLongSide, 1, 200),
      pieceLengthShortSide: clamp(input.phasePadHardware.pieceLengthShortSide, 1, 200),
