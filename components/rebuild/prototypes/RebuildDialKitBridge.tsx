      ...
      ...(activeVariant === 'concept4'
        ? {
            c4Literal: {
              ...
              connectorPath: {
                _collapsed: true,
                horizontalInset: [seed.c4Literal.connectorGeometry.horizontalInset, 0, 32, 1],
                joystickAvoidanceGap: [seed.c4Literal.connectorGeometry.joystickAvoidanceGap, 0, 42, 1],
                liveLoopOffset: [seed.c4Literal.connectorGeometry.liveLoopOffset, 0, 44, 1],
                strokeThickness: [seed.c4Literal.connectorGeometry.strokeThickness, 0.75, 6, 0.05],
              ...
              loadingBar: {
                playDurationMs: [seed.c4Literal.connectorMotion.playDurationMs, 180, 1600, 10],
                restProgress: [seed.c4Literal.connectorMotion.restProgress, 0, 0.45, 0.01],
                headLength: [seed.c4Literal.connectorMotion.headLength, 0.04, 0.28, 0.01],
                glowStrength: [seed.c4Literal.connectorMotion.glowStrength, 0, 1.2, 0.01],
