  ...
  const params = useDialKit(
    panelName,
    {
      ...
      joystick: {
        ...
        haloIntensity: [seed.joystick.haloIntensity, 0, 1.25],
      ...
      ...(usesPhasePadHardware
        ? {
            phasePadHardware: {
              ...
              pieceLengthLongSide: [seed.phasePadHardware.pieceLengthLongSide, 1, 64, 0.1],
              pieceLengthShortSide: [seed.phasePadHardware.pieceLengthShortSide, 1, 64, 0.1],
